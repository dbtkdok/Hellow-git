...
public class ClassSelectController {
	...
	public String addClass(@ModelAttribute("searchVO") SampleDefaultVO searchVO, ClassSelectVO classselectVO, BindingResult bindingResult, Model model, SessionStatus status)
			throws Exception {

		classselectService.insertClass(classselectVO);
		return "forward:/classSelectpage.do";
	}
}
